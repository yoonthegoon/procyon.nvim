...
-- package.loaded['procyon/palettes/' .. bg] = nil -- Only needed for development
local palette = require("procyon/palettes/" .. bg)
...
local enable_font_variants = vim.g.procyon_enable_font_variants == nil or vim.g.procyon_enable_font_variants
