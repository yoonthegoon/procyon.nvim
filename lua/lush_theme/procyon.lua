...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    MatchParen     {bg = normal.cyan }, -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    Whitespace     {fg = normal.blue, gui = "bold" }, -- "nbsp", "space", "tab" and "trail" in 'listchars'
